...
async function testRoute() {
  try {
    ...
    console.log("✅ Companies entity found:");
    ...
    if (adminUser) {
      ...
      // Check permissions
      const hasPermission = await db.userRoles.countUserPermission(adminUser.id, null, "admin.entities.view");
      console.log(`\n✅ Admin has entities.view permission: ${hasPermission > 0}`);
    } else {
      console.log("\n❌ Admin user not found");
    }

    console.log("\n✅ Route should work when authenticated!");
    console.log("\nTo test:");
