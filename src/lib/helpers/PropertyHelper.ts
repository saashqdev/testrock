...
import { EntityWithPropertiesDto, PropertyWithDetailsDto } from "@/db/models/entityBuilder/EntitiesModel";
...
export function validatePropertyValue({ t, property, value }: { t?: TFunction; property: PropertyWithDetailsDto; value: any }) {
...
export function validatePropertyValue_Media({ t, property, media }: { t?: TFunction; property: PropertyWithDetailsDto; media: MediaDto[] }) {
  const max = PropertyAttributeHelper.getPropertyAttributeValue_Number(property, PropertyAttributeName.Max);
  const min = PropertyAttributeHelper.getPropertyAttributeValue_Number(property, PropertyAttributeName.Min);
...
export function validatePropertyValue_Multiple({
  t,
  property,
  multiple,
}: {
...
export function getFormProperties({ mode, entity, properties }: { mode: "create" | "edit"; entity: EntityWithPropertiesDto; properties?: string[] }) {
