      ...
      views: [
        {
          ...
          href: `/admin/entities/${entity.slug}/no-code/${entity.slug}/all-in-one`,
          icon: <ListIcon className="mx-auto h-4 w-4 text-foreground" />,
        },
        {
          name: "List (default)",
          description: "Table or Kanban + Custom Views",
          href: `/admin/entities/${entity.slug}/no-code/__autogenerated`,
          icon: <ListIcon className="mx-auto h-4 w-4 text-foreground" />,
        },
        {
          name: "New",
          description: "Creates a new entity row",
          href: `/admin/entities/${entity.slug}/no-code/__autogenerated/new`,
          icon: <PlusIcon className="mx-auto h-4 w-4 text-foreground" />,
        },
        {
          name: "Overview",
          description: "Details + Tasks + Comments + Tags",
          href: rows.length > 0 ? `/admin/entities/${entity.slug}/no-code/__autogenerated/${rows[0].id}` : undefined,
        ...
        },
        {
          ...
          href: rows.length > 0 ? `/admin/entities/${entity.slug}/no-code/__autogenerated/${rows[0].id}/edit` : undefined,
          error: rows.length === 0 ? "No rows" : undefined,
        ...
        },
        {
          ...
          href: `/admin/entities/${entity.slug}/no-code/__autogenerated/import`,
          icon: <UploadIcon className="mx-auto h-4 w-4 text-foreground" />,
        },
        {
          name: "Export",
          description: "Exports entity rows to .csv",
          href: `/admin/entities/${entity.slug}/no-code/__autogenerated/export`,
          reloadDocument: true,
        ...
        },
        {
          ...
          href: rows.length > 0 ? `/admin/entities/${entity.slug}/no-code/__autogenerated/${rows[0].id}/tags` : undefined,
          error: rows.length === 0 ? "No rows" : undefined,
          reloadDocument: true,
        ...
        },
        {
          ...
          href: rows.length > 0 ? `/admin/entities/${entity.slug}/no-code/__autogenerated/${rows[0].id}/share` : undefined,
          error: rows.length === 0 ? "No rows" : undefined,
          reloadDocument: true,
