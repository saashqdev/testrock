...
function getBlockPreviews({ t, entities }: { t: TFunction; entities: EntityWithDetailsDto[] }) {
...
function getEntityPreviews(entity: EntityWithDetailsDto, rows: RowWithDetailsDto[]) {
      ...
      views: [
        {
          ...
          icon: <ListIcon className="mx-auto h-4 w-4 text-foreground" />,
        },
        {
          name: "List (default)",
        ...
        },
        {
          ...
          icon: <PrototypeIcon className="mx-auto h-4 w-4 text-foreground" />,
        },
        {
          name: "Edit",
          ...
          error: rows.length === 0 ? "No rows" : undefined,
          icon: <EditIcon className="mx-auto h-4 w-4 text-foreground" />,
        },
        {
          name: "Import",
          description: "Imports entity rows from a .csv",
          href: `${entity.slug}/import`,
          icon: <UploadIcon className="mx-auto h-4 w-4 text-foreground" />,
        },
        {
          name: "Export",
          ...
          reloadDocument: true,
          icon: <DownloadIcon className="mx-auto h-4 w-4 text-foreground" />,
        },
        {
          name: "Tags",
          ...
          error: rows.length === 0 ? "No rows" : undefined,
          reloadDocument: true,
          icon: <TagsIcon className="mx-auto h-4 w-4 text-foreground" />,
        },
        {
          name: "Share",
          ...
          error: rows.length === 0 ? "No rows" : undefined,
          reloadDocument: true,
          icon: <ShareIcon className="mx-auto h-4 w-4 text-foreground" />,
        },
        {
          name: "Public URL",
          ...
          reloadDocument: true,
          icon: <LinkIcon className="mx-auto h-4 w-4 text-foreground" />,
        },
        // {
        //   name: "Relationships",
