...
function getTitle({ fromEntityId, relationship }: { fromEntityId: string; relationship: EntityRelationshipWithDetailsDto }) {
...
function getTitleWithName({ fromEntityId, relationship }: { fromEntityId: string; relationship: EntityRelationshipWithDetailsDto }) {
  if (relationship.title) {
    return relationship.title;
  }
  const isParent = relationship.parentId === fromEntityId;
