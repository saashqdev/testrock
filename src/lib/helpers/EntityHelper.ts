...
import { AppOrAdminData } from "@/lib/state/useAppOrAdminData";
...
function getFilters({ t, entity, pagination }: { t: TFunction; entity: EntityWithDetailsDto; pagination?: PaginationDto }) {
...
function getEntityRoute({ entity, params, appOrAdminData }: { entity: EntityWithDetailsDto; params: Params; appOrAdminData: AppOrAdminData }) {
...
function exportEntitiesToTemplate(entities: EntityWithDetailsDto[], relationships: EntityRelationshipWithDetailsDto[]) {
