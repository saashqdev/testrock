...
function getPropertyAttributeValue(property: PropertyWithDetailsDto, name: PropertyAttributeName) {
...
function getPropertyAttributeValue_String(property: PropertyWithDetailsDto, name: PropertyAttributeName) {
  return getPropertyAttributeValue(property, name);
}

function getPropertyAttributeValue_Number(property: PropertyWithDetailsDto, name: PropertyAttributeName) {
...
function getPropertyAttributeValue_Boolean(property: PropertyWithDetailsDto, name: PropertyAttributeName) {
  const value = getPropertyAttributeValue(property, name);
  if (value) {
    return value === "true";
  }
