...
function displayTenant(): RowHeaderDisplayDto<RowWithDetailsDto> {
  return {
...
function displayOrder(): RowHeaderDisplayDto<RowWithDetailsDto> {
  return {
...
function displayTags(): RowHeaderDisplayDto<RowWithDetailsDto> {
  return {
...
function displayProperty(entity: EntityWithDetailsDto, property: PropertyWithDetailsDto, layout?: string): RowHeaderDisplayDto<RowWithDetailsDto> {
  return {
    name: property.name,
...
function displayCreatedAt(): RowHeaderDisplayDto<RowWithDetailsDto> {
  return {
...
function displayCreatedBy(): RowHeaderDisplayDto<RowWithDetailsDto> {
  return {
...
function getDisplayedHeaders({
  ...
  let headers: RowHeaderDisplayDto<RowWithDetailsDto>[] = [];
  ...
  if (columns && columns.length > 0) {
    const newOrder: RowHeaderDisplayDto<RowWithDetailsDto>[] = [];
