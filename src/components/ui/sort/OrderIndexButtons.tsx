  ...
  return (
    <div className={clsx("flex items-center space-x-1 truncate", className)}>
      <button
        ...
        className={clsx(
          !editable || idx <= 0 ? "cursor-not-allowed bg-secondary/90 text-gray-300" : "hover:bg-secondary/90 hover:text-foreground",
      ...
      <button
        ...
        className={clsx(
          !editable || idx >= items.length - 1 ? "cursor-not-allowed bg-secondary/90 text-gray-300" : "hover:bg-secondary/90 hover:text-foreground",
          "focus:outline-hidden h-4 w-4 bg-secondary px-0.5 py-0.5 text-muted-foreground"
        )}
