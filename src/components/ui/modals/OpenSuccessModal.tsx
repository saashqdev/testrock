    ...
    <Transition show={open} as={Fragment}>
      <Dialog as="div" className={clsx(className, "fixed inset-0 z-50 overflow-y-auto")} onClose={onClose}>
        <div className="flex min-h-screen items-end justify-center px-4 pb-20 pt-4 text-center sm:block sm:p-0">
          ...
          >
            <Dialog.Panel className="inline-block w-full transform overflow-hidden rounded-lg bg-background px-4 pb-4 pt-5 text-left align-bottom shadow-xl transition-all sm:my-8 sm:max-w-sm sm:p-6 sm:align-middle">
              <div>
              ...
              <div className="mt-5 sm:mt-6">
                <button
                  type="button"
                  className="shadow-2xs focus:outline-hidden mt-0 inline-flex w-full justify-center rounded-md border border-transparent bg-foreground/90 px-4 py-2 text-sm font-medium text-background hover:bg-foreground focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                  onClick={onClose}
                >
