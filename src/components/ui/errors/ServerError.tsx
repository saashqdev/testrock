...
export default function ServerError({ error }: { error?: any }) {
  ...
  if (KNOWN_ERRORS.hasOwnProperty(errorTitle)) {
    let knownError = KNOWN_ERRORS[errorTitle];
...
const KNOWN_ERRORS: Record<string, { title: string; description?: string; stack?: string }> = {
