        ...
        <div className="space-y-2">
          {onChangeContentType && (
            <div className="flex items-center space-x-1">
              <button type="button" onClick={() => onChangeContentType("wysiwyg")} className="text-xs text-muted-foreground hover:underline">
                <div className={clsx(contentType === "wysiwyg" ? "font-bold" : "")}>WYSIWYG</div>
              </button>
              <div>•</div>
              <button type="button" onClick={() => onChangeContentType("markdown")} className="text-xs text-muted-foreground hover:underline">
