...
import { FileBase64 } from "@/lib/dtos/shared/FileBase64";
  ...
  return (
    <div className={clsx(className, "")}>
      ...
      <div className="mt-1">
        ...
        {isDisabled() && items.length === 0 && (
          <div>
            <div className="flex h-12 w-full cursor-not-allowed items-center justify-center rounded-md border border-dashed border-border">
