          ...
          return (
            <li key={item.value}>
              <label
                ...
                className={clsx(
                  clsx(
                    isChecked(item.value) ? "border-transparent ring-2 ring-ring" : "",
                ...
                <div className="block w-full">
                  ...
                  <div className="flex w-full justify-between truncate">
                    ...
                    <CheckFilledCircleIcon
                      className={clsx("flex-shrink-0", !isChecked(item.value) && "invisible", "h-5 w-5 text-primary")}
                      aria-hidden="true"
                    />
                    <span
                      className={clsx(isChecked(item.value) ? "border-transparent ring-ring" : "border", "pointer-events-none absolute -inset-px rounded-lg")}
                      aria-hidden="true"
                    />
                  </div>
