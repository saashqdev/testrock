    ...
    <div ref={clickOutside} className="relative">
      <div className="inline-flex divide-x divide-gray-300 rounded-sm shadow-none">
        ...
        >
          {(() => {
            if (user?.avatar) {
              return <Image className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-slate-800" src={user.avatar} alt="Avatar" />;
            } else {
              return (
              ...
              <>
                ...
                {/* {getUserHasPermission(appOrAdminData, "app.settings.roles.view") && (
                  <Link
                    ...
                    role="menuitem"
                    onClick={closeDropdownUser}
                    href={!params.tenant ? "" : UrlUtils.currentTenantUrl(params, "settings/roles-and-permissions")}
                  >
                ...
                {/* <Link
                  ...
                  role="menuitem"
                  onClick={closeDropdownUser}
                  href={!params.tenant ? "" : UrlUtils.currentTenantUrl(params, "settings/groups")}
                >
