                          ...
                          {issue.img?.map((image, idx) => {
                            return (
                              <Image
                                ...
                                alt={image.title}
                                src={image.img}
                                className="w-28 cursor-pointer overflow-hidden rounded-lg border-2 border-dashed border-border object-cover shadow-lg hover:border-border hover:opacity-90 hover:shadow-2xl"
                              />
                            );
                          })}
                        </div>
                          ...
                          {issue.img?.map((image, idx) => {
                            return (
                              <div key={idx} className="">
                                <Image alt={image.title} src={image.img} className="object-cover rounded-lg shadow-lg overflow-hidden" />
            ...
            <div>
              <div className="">
                ...
                <div className="mt-4 space-y-3">
                  <div>
                    <Image alt={selectedImage.title} className="mx-auto h-96 object-contain" src={selectedImage.img} />
                  </div>
                </div>
              </div>
            </div>
