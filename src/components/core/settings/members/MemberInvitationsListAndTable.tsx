                    ...
                    {headers.map((header, idx) => {
                      return (
                        <th
                          ...
                          scope="col"
                          className={clsx(
                            "select-none truncate px-2 py-1 text-left text-xs font-medium tracking-wider text-muted-foreground",
                            header.name && "cursor-pointer hover:text-foreground/80"
                          )}
                        >
                  ...
                  {items.map((item, idx) => {
                    return (
                      <tr key={idx}>
                        ...
                        <td className="w-20 whitespace-nowrap px-2 py-2 text-sm text-muted-foreground">
