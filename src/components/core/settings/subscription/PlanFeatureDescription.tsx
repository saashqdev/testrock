  ...
  return (
    <div className="flex items-center">
      {feature.type > 0 && feature.type !== SubscriptionFeatureLimitType.NOT_INCLUDED ? (
        <svg className="h-4 w-4 shrink-0 text-primary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          <path
            fillRule="evenodd"
      ...
      {feature.href?.startsWith("http") ? (
        <Fragment>
          {editing ? (
            <div className="ml-2 truncate text-sm font-medium text-muted-foreground underline hover:text-primary dark:text-muted-foreground">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="ml-2 truncate text-sm font-medium text-muted-foreground underline hover:text-primary dark:text-muted-foreground"
            >
              <FeatureTitle feature={feature} />
            </a>
          )}
        ...
        <Fragment>
          {editing ? (
            ...
            <Link href={feature.href} className="ml-2 truncate text-sm font-medium text-muted-foreground underline hover:text-primary dark:text-muted-foreground">
              <FeatureTitle feature={feature} />
            </Link>
          )}
        </Fragment>
