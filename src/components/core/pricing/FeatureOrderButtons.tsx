      ...
      {index !== undefined && (
        <div className="flex items-center space-x-1 truncate">
          ...
          <button
            ...
            className={clsx(
              index <= 0 || !editable ? "cursor-not-allowed bg-secondary/90 text-gray-300" : "hover:bg-secondary/90 hover:text-foreground",
          ...
          <button
            ...
            className={clsx(
              isLastItem() || !editable ? "cursor-not-allowed bg-secondary/90 text-gray-300" : "hover:bg-secondary/90 hover:text-foreground",
              "focus:outline-hidden h-4 w-4 bg-secondary px-0.5 py-0.5 text-muted-foreground"
            )}
