...
import { SubscriptionUsageBasedUnitDto } from "@/lib/dtos/subscriptions/SubscriptionUsageBasedUnitDto";
  ...
  return (
    <div className="space-y-2">
      ...
      <button
        ...
        disabled={disabled}
        className={clsx(
          "focus:ring-3 flex items-center space-x-1 rounded-md border border-border bg-background px-2 py-1 text-xs text-muted-foreground focus:text-foreground focus:ring-gray-300 focus:ring-offset-1",
          disabled ? "cursor-not-allowed bg-secondary" : "hover:bg-secondary/90"
        )}
      >
