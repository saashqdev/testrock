  ...
  return (
    <SlideOverWideEmpty title={`Options: ${t(title)}`} size="2xl" open={open} onClose={() => setOpen(false)}>
      <div className="">
          ...
          <div className="mt-3 sm:mt-5">
            <div className="mt-4 space-y-3">
              <div className="flex space-x-3">
                <InputCheckboxInline name="with-colors" title="With colors" description="" value={withColors} onChange={setWithColors} />
                <InputCheckboxInline
              ...
              <div className="w-full">
                <div className="flex items-center justify-between space-x-2">
                  <label htmlFor="select" className="block text-sm font-medium text-foreground/80">
                    Options
                  </label>
                ...
                <div className="mt-1 space-y-2 rounded-md border-2 border-dashed border-border bg-secondary p-2">
        ...
        <div className="mt-5 border-t border-border pt-3 sm:mt-6">
