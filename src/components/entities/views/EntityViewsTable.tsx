    ...
    <TableSimple
      ...
      headers={[
        ...
        },
        {
          ...
          value: (i) => (
            <div>
              <EntityViewLayoutBadge layout={i.layout} className="mx-auto h-5 w-5 text-muted-foreground" />
            </div>
          ),
        },
        {
                ...
                {i.isSystem ? (
                  ...
                  <div className="flex flex-col">
                    <div className="font-medium italic">
                      Default <span className="text-xs font-normal text-muted-foreground">(all accounts)</span>
                    </div>
                  </div>
                ) : i.tenant && i.user ? (
                  <div className="flex items-center space-x-1">
        ...
        },
        {
          ...
          value: (i) => <div>{i.isDefault ? <CheckIcon className="h-5 w-5 text-green-500" /> : <XIcon className="h-5 w-5 text-muted-foreground" />}</div>,
        },
        {
          name: "updatedAt",
      ...
      noRecords={
        <div className="p-12 text-center">
          <h3 className="mt-1 text-sm font-medium text-foreground">No views yet</h3>
          <p className="mt-1 text-sm text-muted-foreground">Create custom views to display your data</p>
        </div>
      }
    />
  );
