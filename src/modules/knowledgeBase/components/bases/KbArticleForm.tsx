...
export default function KbArticleForm({ item }: { item: KnowledgeBaseArticleWithDetailsDto }) {
        ...
        <div className="space-y-2">
          <div className="flex justify-between space-x-2">
            ...
            <div className="flex items-center space-x-1">
              <button type="button" onClick={() => setContentType("wysiwyg")} className="text-xs text-muted-foreground hover:underline">
                <div className={clsx(contentType === "wysiwyg" ? "font-bold" : "")}>WYSIWYG</div>
              </button>
              <div>•</div>
              <button type="button" onClick={() => setContentType("markdown")} className="text-xs text-muted-foreground hover:underline">
