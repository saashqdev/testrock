...
import type { Colors } from "@/lib/enums/shared/Colors";
        ...
        {items.map((item) => {
          return (
            <Link
              href={item.href}
              key={item.id}
              className="shadow-2xs rounded-md border border-border bg-background px-3 py-4 hover:border-secondary-foreground hover:bg-secondary"
            >
