...
import { TenantUserInvitationsModel } from "@/db/models";
...
interface Props {
  appUrl: string;
  items: TenantUserInvitationsModel[];
  canDelete: boolean;
...
export default function MemberInvitationsListAndTable({ appUrl, items, canDelete, serverAction }: Props) {
  ...
  function deleteUserInvitation(invitation: TenantUserInvitationsModel) {
  ...
  function getInvitationLink(invitation: TenantUserInvitationsModel) {
