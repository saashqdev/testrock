          ...
          <TabsWithIcons
            tabs={[
              ...
              },
              {
                ...
                href: "?status=live",
                current: newSearchParams.get("status") === "live",
              },
              {
              ...
              },
              {
                ...
                current: newSearchParams.get("status") === "archived",
              },
            ]}
          />
        </div>
      ...
      <TableSimple
        ...
        headers={[
          ...
          },
          {
            ...
            value: (i) => (
              <div className="flex flex-col">
                <div className="flex flex-col">
                  <Link href={`${i.id}`} className="text-base font-bold hover:underline">
                    {i.name} {i.appliesToAllTenants && !params.tenant && <span className="text-xs text-blue-500">(All accounts) </span>}
                  </Link>
                  <div className="text-xs text-muted-foreground">{i.description || "No description"}</div>
                </div>
              </div>
            ),
          },
          {
            ...
            title: "Blocks",
            value: (i) => (
              <Link href={`${i.id}`} className="text-sm text-muted-foreground underline hover:text-foreground">
          ...
          },
          {
            ...
            title: "Executions",
            value: (i) => (
              <Link href={`${i.id}/executions`} className="text-sm text-muted-foreground underline hover:text-foreground">
        ...
        noRecords={
          <div className="p-12 text-center">
            <h3 className="mt-1 text-sm font-medium text-foreground">{"No workflows"}</h3>
            <p className="mt-1 text-sm text-muted-foreground">{"Get started by creating a new workflow"}</p>
          </div>
        }
      />
