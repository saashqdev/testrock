    ...
    <div>
      {conditions.length === 0 ? (
        <div className="flex flex-col items-center justify-center rounded-md border border-border bg-secondary/90 p-2 text-center">
          <div className="text-sm font-medium text-muted-foreground">No conditions</div>
        </div>
      ) : (
          ...
          <div className="flex h-10 items-center justify-between space-x-2">
            ...
            {conditions.length > 1 && (
              <select
                ...
                className="focus:outline-hidden col-span-2 rounded-lg border border-border bg-secondary px-2 py-2 pr-10 text-sm hover:bg-secondary/90"
              >
            ...
            {conditions.map((condition, idx) => (
              <div key={idx} className="group relative">
                ...
                <div className="grid grid-cols-10 gap-1">
                  ...
                  />
                  <select
                    className="focus:outline-hidden col-span-2 w-full rounded-lg border border-border bg-secondary px-2 py-2 text-sm hover:bg-secondary/90"
