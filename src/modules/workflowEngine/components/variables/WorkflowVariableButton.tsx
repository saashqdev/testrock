  ...
  return (
    <Fragment>
      <button
        ...
        className="focus:outline-hidden rounded-md border border-border bg-secondary p-1 text-xs font-medium text-muted-foreground hover:bg-background hover:text-foreground focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
      >
            ...
            <div className="space-y-1">
              {group.variables.map((variable) => (
                <button
                  type="button"
                  key={variable.name}
                  className="flex w-full items-center space-x-2 truncate rounded-md border border-border bg-background px-2 py-2 text-sm hover:bg-secondary"
