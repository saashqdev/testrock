      ...
      <div className="">
        ...
        <div className="space-y-4 px-4 py-4">
          <div className="space-y-2">
            ...
            <div>
              <input
                className="focus:outline-hidden w-full rounded-lg px-1 py-1 text-sm text-muted-foreground hover:bg-secondary/90"
          ...
          {errors.length > 0 && (
            <Fragment>
              ...
              <div className="space-y-3">
                <div className="text-sm font-medium text-foreground/80">Errors</div>
          ...
          {workflowBlock.value === "if" && (
            <Fragment>
              <div className="border-t border-border"></div>
              <div className="space-y-3">
                <div className="text-sm font-medium text-foreground/80">Conditions</div>
          ...
          {workflowBlock.inputs.length > 0 && (
            <Fragment>
              <div className="border-t border-border"></div>
              <div className="space-y-3">
                <div className="text-sm font-medium text-foreground/80">Inputs</div>
                <div className="space-y-1">
          ...
          {workflowBlock.outputs.length > 0 && (
            <Fragment>
              <div className="border-t border-border"></div>
              <div className="space-y-3">
                <div className="text-sm font-medium text-foreground/80">Outputs</div>
                <div className="space-y-1">
          ...
          {block.type === "if" ? (
            <div className="space-y-3">
              <div className="space-y-0.5 text-sm">
                <div className="font-medium text-foreground/80">Next blocks</div>
            ...
            <div className="space-y-3">
              <div className="space-y-0.5 text-sm">
                <div className="font-medium text-foreground/80">Next block</div>
              ...
              <div className="space-y-1">
                {block.toBlocks.map(({ toBlockId }) => {
                  ...
                  return (
                    <button
                      type="button"
                      key={toBlockId}
                      className="group w-full rounded-lg border border-border bg-background p-2 text-left hover:bg-secondary"
                      ...
                      <div className="flex justify-between space-x-2 text-sm font-medium">
                        <div>
                          ...
                          {nextWorkflowBlock.description && (
                            <span className="text-xs font-normal text-muted-foreground">({nextWorkflowBlock.description || ""})</span>
                          )}
                        </div>
                        <button
                          type="button"
                ...
                <button
                  type="button"
                  className="w-full rounded-lg border border-dashed border-border bg-background p-2 text-left text-sm font-medium hover:border-dotted hover:border-gray-800 hover:bg-secondary/90"
  ...
  return (
    <div key={input.name} className="space-y-1">
      <div className="flex items-center justify-between space-x-2">
        <label htmlFor={"input-" + input.name} className="flex justify-between space-x-2 truncate text-xs font-medium text-muted-foreground">
          {input.label}{" "}
          {input.href && (
            <span className="ml-1 font-normal underline">
              <Link href={input.href.url} target="_blank">
                ({input.href.label})
              </Link>
            </span>
          )}
      ...
      {input.type === "select" && (
        <select
          name={input.name}
          id={input.name}
          className="focus:outline-hidden w-full rounded-lg border border-border bg-secondary px-2 py-2 text-sm hover:bg-secondary/90"
          value={inputValue as string}
  ...
  if (!nextBlock) {
    return (
      <div className="space-y-0.5">
        <label className="flex justify-between space-x-2 truncate text-xs font-medium uppercase text-muted-foreground">{title}</label>
        <button
          type="button"
    ...
    <div className="space-y-0.5">
      ...
      >
        <div className="flex justify-between space-x-2 text-sm font-medium">
          <div>
            {workflowBlock.name}{" "}
            {nextWorkflowBlock.description && <span className="text-xs font-normal text-muted-foreground">({nextWorkflowBlock.description || ""})</span>}
          </div>
          <button
            type="button"
            onClick={(e) => {
