  ...
  return (
    <DropdownOptions
      ...
      button={
        <div
          className={clsx(
            "shadow-2xs rounded px-2 py-1 text-sm font-semibold text-foreground/80 ring-1 ring-inset ring-gray-300",
            WorkflowUtils.canRun(workflow) ? "bg-background hover:bg-secondary/90" : "cursor-not-allowed bg-secondary/90 opacity-50"
          )}
        >
