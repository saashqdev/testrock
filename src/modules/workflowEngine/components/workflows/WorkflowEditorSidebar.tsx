                ...
                return (
                  ...
                  >
                    <span
                      ...
                      className="focus:outline-hidden absolute right-2 top-2 hidden cursor-pointer rounded-md bg-background text-muted-foreground hover:text-muted-foreground focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 group-hover:block"
                    >
