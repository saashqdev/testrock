  ...
  return (
    <Modal open={open} setOpen={onClosing} size="lg">
      <form onSubmit={onSubmit} className="inline-block h-full w-full overflow-visible p-1 text-left align-bottom sm:align-middle">
        ...
        <div className="mt-3">
          <h3 className="text-lg font-medium leading-6 text-foreground">{idx === undefined ? "New Formula Component" : "Edit Formula Component"}</h3>
        </div>
          ...
          <div className="grid gap-2">
            ...
            {type === "variable" ? (
              ...
              <InputSelect
                ...
                title="Operator"
                value={value}
                onChange={(e) => setValue(FormulaHelpers.getOperatorType(e?.toString() ?? ""))}
                required
              ...
              <InputSelect
                ...
                title="Parenthesis"
                value={value}
                onChange={(e) => setValue(FormulaHelpers.getParenthesisType(e?.toString() ?? ""))}
                required
