...
import { OnboardingSessionsModel } from "@/db/models/onboarding/OnboardingSessionsModel";
import { useTranslation } from "react-i18next";
import { Colors } from "@/lib/enums/shared/Colors";
import SimpleBadge from "@/components/ui/badges/SimpleBadge";

export default function OnboardingSessionBadge({ item }: { item: OnboardingSessionsModel }) {
