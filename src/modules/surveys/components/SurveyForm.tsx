...
interface Props {
  item: SurveyWithDetailsDto | null;
        ...
        <div className="space-y-2">
          ...
          <div>
            <InputNumber
              ...
              onChange={(e) => setState({ ...state, minSubmissions: Number(e) })}
            />
          </div>
          ...
          <div>
            <InputCheckboxWithDescription
              ...
              onChange={(e) => setState({ ...state, isEnabled: Boolean(e) })}
          ...
          <div>
            <InputCheckboxWithDescription
              ...
              onChange={(e) => setState({ ...state, isPublic: Boolean(e) })}
