              ...
              <div className="border-border mt-2 border-t pt-4">
                ...
                <div className=" grid grid-cols-12 gap-2">
                  <InputSelect
                    ...
                    onChange={(e) => onChange([...items.slice(0, idx), { ...item, type: e as any }, ...items.slice(idx + 1)])}
                    options={[
                      {
                        value: "single-select",
                        name: "Single Select",
                  ...
                  <InputSelect
                    ...
                    title={"Color"}
                    value={item.color}
                    onChange={(e) => onChange([...items.slice(0, idx), { ...item, color: e?.toString() ?? ("" as any) }, ...items.slice(idx + 1)])}
                    options={[
                  ...
                  <InputSelect
                    ...
                    value={item.style}
                    className="col-span-4"
                    onChange={(e) => onChange([...items.slice(0, idx), { ...item, style: e as any }, ...items.slice(idx + 1)])}
                    options={[
                      {
                        value: "default",
                        name: "Default",
