...
export const COMPANY_SAMPLE_ENTITY_TEMPLATE: EntitiesTemplateDto = {
  entities: [
    {
      type: DefaultEntityTypes.AdminOnly,
      name: "companySample",
      ...
      hasTasks: true,
      properties: [
        { name: "customText", title: "Custom Text", type: "string", isRequired: true, isDisplay: true },
        { name: "customNumber", title: "Custom Number", type: "number", isRequired: true },
        { name: "customDate", title: "Custom Date", type: "date", isRequired: true },
        { name: "customBoolean", title: "Custom Boolean", type: "boolean", isRequired: true },
        {
          name: "customSelect",
          title: "Custom Select",
          type: "select",
          isRequired: true,
          options: [
            { value: "option1", name: "Option 1", color: Colors.BLUE },
            { value: "option2", name: "Option 2", color: Colors.GREEN },
            { value: "option3", name: "Option 3", color: Colors.RED },
          ],
        },
      ],
    },
