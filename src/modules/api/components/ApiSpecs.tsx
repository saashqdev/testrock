  ...
  return (
    <div className={clsx("grid gap-4", item.postmanCollection ? "grid-cols-2" : "grid-cols-1")}>
      <div className="space-y-2">
        {withLinkToDocs && (
          <Link href="/api/docs" target="_blank">
            <div className="rounded-md border border-transparent px-2 py-1.5 hover:border-border hover:bg-background">
              <div className="flex items-center justify-between space-x-2">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="truncate text-sm font-medium text-foreground">View OpenAPI 3.0 Docs</div>
                </div>
      ...
      {item.postmanCollection && (
        <div className="space-y-2">
          {withLinkToDocs && (
            <Link href="/postman_collection.json" target="_blank">
              <div className="rounded-md border border-transparent px-2 py-1.5 hover:border-border hover:bg-background">
                <div className="flex items-center justify-between space-x-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="truncate text-sm font-medium text-foreground">Download Postman Collection</div>
                  </div>
                  <ExternalLinkEmptyIcon className="ml-2 h-4 w-4" />
                </div>
              </div>
