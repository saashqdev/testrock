  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      <button
        ...
        className={clsx(
          "mt-2 flex items-center space-x-1 rounded-md border border-border px-2 py-1 text-xs text-gray-600 focus:text-gray-800 focus:ring focus:ring-gray-300 focus:ring-offset-1",
