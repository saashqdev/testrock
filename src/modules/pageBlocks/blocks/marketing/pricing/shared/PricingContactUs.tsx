...
import { PricingContactUsDto } from "../PricingBlockDto";
            ...
            <div className="mt-6">
              <div className="mx-auto max-w-md rounded-md shadow">
                <ButtonEvent
                  ...
                  to="/contact"
                  className="inline-flex w-full justify-center rounded-md border-0 bg-primary px-4 py-3 text-lg text-primary-foreground shadow-sm hover:bg-primary/95 focus:outline-none"
                >
                  {t("pricing.contact")}
                </ButtonEvent>
              </div>
