...
export default function PageBlocks({
  ...
  // Use rootData.userSession directly - useRootData hook already handles SSR
  const userSession = rootData.userSession;
          ...
          return (
            <Fragment key={idx}>
              <div className={clsx("group relative", item.header && "z-10")}>
                ...
                {editor && (
                  ...
                  >
                    <div className="mx-auto flex w-full max-w-md items-center justify-between">
                      <div className="text-lg font-extrabold capitalize text-foreground">{getType(item)}</div>
                ...
                <div
                  className={clsx(
                    editor && "rounded-md rounded-t-none border-2 border-b-0 border-t-0 border-dashed border-transparent group-hover:border-border",
              ...
              {Object.keys(PageBlockUtils.defaultBlocks).map((type) => {
                return (
                  <button
                    ...
                    className="focus:outline-hidden group flex w-full flex-col items-center space-y-2 rounded-md border-2 border-dashed border-border bg-secondary p-2 hover:border-gray-800 hover:bg-secondary/90 focus:border-transparent focus:bg-secondary/90 focus:ring-2 focus:ring-gray-800"
                  >
