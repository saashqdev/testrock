...
export default function BannerVariantTop({ item, onClose }: { item: BannerBlockDto; onClose?: () => void }) {
  ...
  return (
    <span>
      {item && open && (
        <div className="border-b-2 border-border bg-primary text-primary-foreground">
            ...
            <div className="flex w-full items-center space-x-3 lg:w-auto lg:justify-end">
              ...
              <div className="order-3 ml-2 hidden shrink-0 sm:flex">
                <button
                  ...
                  className="focus:outline-hidden -mr-1 flex rounded-md border border-transparent p-2 text-primary-foreground hover:border-border focus:ring-2 sm:-mr-2"
                >
