    ...
    <div className="space-y-4">
      <InputGroup title="Design">
        <InputRadioGroup
          title="Style"
          value={state.style}
          onChange={(value) => setState({ ...state, style: value as HeaderBlockStyle })}
      ...
      <InputGroup title="Options">
        <div className="space-y-2">
          <InputCheckboxWithDescription
            ...
            onChange={(e) => setState({ ...state, withLogo: Boolean(e) })}
          />
          <InputCheckboxWithDescription
            ...
            onChange={(e) => setState({ ...state, withSignInAndSignUp: Boolean(e) })}
          />
          <InputCheckboxWithDescription
            ...
            onChange={(e) => setState({ ...state, withDarkModeToggle: Boolean(e) })}
          />
          <InputCheckboxWithDescription
