                  ...
                  <div className="-mr-1 flex items-center space-x-2 md:hidden">
                    ...
                    {item.links.length > 0 && (
                      <button
                        ...
                        type="button"
                        className="focus:outline-hidden inline-flex items-center justify-center rounded-md p-2 text-muted-foreground hover:bg-secondary hover:text-secondary-foreground"
                        id="main-menu"
                        aria-haspopup="true"
                      >
                    ...
                    <Fragment key={idx}>
                      {!link.items || link.items.length === 0 ? (
                        <ButtonEvent
                          ...
                          className={clsx(
                            link.className,
                            "focus:outline-hidden truncate rounded-sm px-3 py-1 text-base font-medium leading-6 transition duration-150 ease-in-out",
                        ...
                        <HeaderFlyoutItem
                          className="focus:outline-hidden rounded-sm px-3 py-1 text-base font-medium leading-6 transition duration-150 ease-in-out"
                          title={t(link.title)}
                          items={link.items}
                        />
                      )}
                ...
                <div className="flex items-center justify-between px-5 pt-4">
                  ...
                  <div className="-mr-2">
                    <button
                      onClick={() => setOpen(!open)}
                      type="button"
                      className="focus:outline-hidden inline-flex items-center justify-center rounded-md p-2 hover:bg-secondary hover:text-secondary-foreground"
                    >
                      <span className="sr-only">{t("shared.close")}</span>
                      {/* Heroicon name: x */}
                      <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
