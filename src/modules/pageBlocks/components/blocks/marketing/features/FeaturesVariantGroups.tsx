...
import ColorDarkUtils from "@/lib/shared/colors/ColorDarkUtils";
      ...
      <section id="features" className="body-font">
        <div className="container mx-auto max-w-6xl space-y-8 px-5 py-12">
          ...
          {item.items.length === 0 ? (
            ...
            <div
              className={clsx(
                "shadow-2xs rounded-lg border p-6",
                  ...
                  <div className="flex flex-col space-y-3">
                    ...
                    <div className="flex flex-col space-y-4">
                      {currentFeature.highlight && (
                        <div>
                          <div className="ring-3 inline-flex cursor-default items-center rounded-md bg-primary px-2 py-1 text-sm font-bold text-primary-foreground ring-ring">
                      ...
                      currentFeature.link ? (
                        ...
                        >
                          <Image
                            ...
                            className="shadow-2xs h-52 overflow-hidden rounded-md border-gray-900 object-cover transition-all duration-500 hover:border-gray-800 sm:h-72 md:h-full"
                          />
                        </ButtonEvent>
                      ) : (
                        <Image
                          ...
                          src={currentFeature.img}
                          alt={currentFeature.name}
                          className="shadow-2xs h-52 overflow-hidden rounded-md border-gray-900 object-cover transition-all duration-500 sm:h-72 md:h-full"
                        />
                      )
                    ) : (
                      <div className="h-52 rounded-md bg-gray-100 dark:bg-gray-800 sm:h-72 md:h-full" aria-hidden />
                    )}
                  </div>
                </div>
              </div>
