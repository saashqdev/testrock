        ...
        <div className="grid grid-cols-4 gap-8 md:grid-cols-4 lg:grid-cols-8">
          ...
          <div className="order-none col-span-1 flex justify-center">
            <ButtonEvent
              ...
              rel="noreferrer"
            >
              <Image className="h-10 object-cover dark:hidden md:h-14" src={LogoPrisma} alt="NextJS" />
              <Image className="hidden h-10 object-cover dark:block md:h-14" src={LogoPrismaDark} alt="NextJS" />
            </ButtonEvent>
          </div>
          <div className="order-first col-span-1 flex justify-center lg:order-none">
            <ButtonEvent
              ...
              rel="noreferrer"
            >
              <Image className="h-10 object-cover dark:hidden md:h-14" src={LogoNextJS} alt="NextJS" />
              <Image className="hidden h-10 object-cover dark:block md:h-14" src={LogoNextJSDark} alt="NextJS" />
            </ButtonEvent>
          </div>
          <div className="order-none col-span-1 flex justify-center">
            <ButtonEvent
