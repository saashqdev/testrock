              ...
              >
                <div className="group: h-full rounded-lg bg-secondary p-6">
                  <svg
                    ...
                    fill="currentColor"
                    className="mb-2 block h-3 w-3 text-muted-foreground"
                  ...
                  {testimonial.title && (
                    <div className="mb-2 flex justify-between space-x-2 text-lg font-medium text-foreground dark:text-white">
                      <div>
