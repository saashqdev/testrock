    ...
    <div className="space-y-4">
      <InputGroup title="Design">
        <InputRadioGroup
          title="Style"
          value={state.style}
          onChange={(value) => setState({ ...state, style: value as BlogPostsBlockStyle })}
      ...
      <InputGroup title="Details">
        <div className="space-y-2">
          <InputCheckboxWithDescription
            ...
            onChange={(e) => setState({ ...state, withCoverImage: Boolean(e) })}
          ...
          <InputCheckboxWithDescription
            ...
            onChange={(e) => setState({ ...state, withAuthorName: Boolean(e) })}
          ...
          <InputCheckboxWithDescription
            ...
            onChange={(e) => setState({ ...state, withAuthorAvatar: Boolean(e) })}
          ...
          <InputCheckboxWithDescription
            ...
            onChange={(e) => setState({ ...state, withDate: Boolean(e) })}
