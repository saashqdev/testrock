        ...
        <div className="flex space-x-2">
          {templates.map((t) => (
            <button
              ...
              className="bg-theme-100 text-theme-700 hover:bg-theme-200 focus:outline-hidden inline-flex items-center rounded border border-transparent px-2 py-2 text-xs font-medium focus:ring-2 focus:ring-ring focus:ring-offset-2"
            >
              {t.title}
            </button>
          ))}
