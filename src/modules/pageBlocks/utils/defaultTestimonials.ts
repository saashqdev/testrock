...
export const defaultTestimonials: TestimonialDto[] = [
  {
    ...
    quote:
      "I've been using SR for 2 years. TheDevs have a deep understanding of his subject, actively listens to the community, and regularly introduces new features to the boilerplate.",
