...
import { PromptFlowExecutionsModel, PromptTemplateResultsModel } from "@/db/models/promptFlows/PromptFlowExecutionsModel";
...
export default function PromptResults({ item }: Props) {
  ...
  function getResults() {
    const results: {
      result: PromptTemplateResultsModel;
      execution: PromptFlowExecutionsModel;
    }[] = [];
                ...
                <div className="truncate">
                  <div className="flex items-center justify-between space-x-2 truncate">
                    <div className="flex flex-col truncate">
                      ...
                      <div className="truncate text-xs italic text-muted-foreground">{DateUtils.dateYMDHMS(item.result.createdAt)}</div>
                    </div>
