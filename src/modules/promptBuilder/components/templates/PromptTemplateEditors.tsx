...
import { PromptFlowWithDetailsDto } from "@/db/models";
          ...
          <div className="flex justify-between space-x-2">
            ...
            <div className="flex items-center space-x-3">
              <button
                ...
                className={clsx(!sampleSourceRow ? "cursor-not-allowed text-muted-foreground opacity-50" : "hover:text-gray-800")}
              >
              ...
              <button type="button" onClick={() => setShowHelp(true)}>
                <QuestionMarkFilledIcon className="h-5 w-5 cursor-pointer text-muted-foreground hover:text-gray-800" />
              </button>
              <button type="button" onClick={onToggleExpanded}>
                {isExpanded ? (
                  <ArrowsPointingIn className="h-5 w-5 cursor-pointer text-muted-foreground hover:text-gray-800" />
                ) : (
                  <ArrowsPointingOut className="h-5 w-5 rotate-180 transform cursor-pointer text-muted-foreground hover:text-gray-800" />
                )}
              </button>
            </div>
            {/* {value.source && (
      ...
      <div className="space-y-2 border-t border-border pt-2">
        <div className="flex items-center space-x-2">
          <div className="w-1/2 space-y-1">
            ...
            <div className="h-[calc(100vh-250px)] overflow-y-scroll break-words rounded-md border border-border bg-secondary/90 p-2 text-muted-foreground">
              {result}
            </div>
          </div>
          ...
          <div className="w-1/2 space-y-1">
            <div className="flex justify-between space-x-2">
              ...
              >
                <ClipboardIcon className="h-5 w-5 text-muted-foreground hover:text-gray-800" />
              </button>
            </div>
            <div className="h-[calc(100vh-250px)] overflow-y-scroll break-words rounded-md border border-border bg-secondary/90 p-2 text-muted-foreground">
