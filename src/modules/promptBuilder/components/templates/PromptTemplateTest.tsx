        ...
        <div className="space-y-2">
          <div className="flex space-x-2">
            <div className="w-1/2 space-y-1">
              ...
              />
              <InputNumber title="Temperature" value={item.temperature} onChange={setTemperature} step="0.1" />
              <InputNumber title="Max Tokens" value={item.maxTokens} onChange={setMaxTokens} />
              <label className="mb-1 flex justify-between space-x-2 truncate text-xs font-medium text-muted-foreground">
                <span>Template</span>
              </label>
              <textarea
                className="h-[calc(100vh-355px)] w-full overflow-y-scroll break-words rounded-md border border-border bg-white p-2 text-muted-foreground"
                value={template}
                onChange={(e) => {
            ...
            <div className="w-1/2">
              ...
              <div className="h-[calc(100vh-170px)] overflow-y-scroll break-words rounded-md border border-border bg-secondary/90 p-2 text-muted-foreground">
                {result}
              </div>
            </div>
          </div>
