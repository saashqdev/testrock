...
interface Props {
  item: PromptFlowExecutionWithResultsDto;
}
                  ...
                  <div className="flex items-center justify-between space-x-2 truncate">
                    <div className="flex flex-col truncate">
                      <div className="flex items-center space-x-1">
                        ...
                        <div className="truncate text-muted-foreground">{result.response ?? "No response"}</div>
                      </div>
                      <div className="truncate text-xs italic text-muted-foreground">{DateUtils.dateYMDHMS(result.createdAt)}</div>
                    </div>
