...
import { PromptBuilderDataDto } from "../../dtos/PromptBuilderDataDto";
...
async function getValue(item: PromptBuilderDataDto, allEntities: EntityWithDetailsDto[]): Promise<string> {
  let result = "";
