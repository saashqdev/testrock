...
export default function NovelEditor({
  ...
  const [selectedPrompt, setSelectedPrompt] = useState<{
    prompt: PromptFlowWithDetailsDto;
    data: {
      text: string;
      selectedText: string;
    };
  ...
  return (
    <div
      ...
      className={clsx(
        "max-w-(--breakpoint-lg) relative w-full border border-border bg-background p-12 px-8 sm:rounded-lg sm:border sm:px-12 sm:shadow-lg",
        className
    ...
    >
      {usingLocalStorage && (
        <div
          className={clsx(
            "absolute right-5 top-5 mb-5 rounded-lg bg-secondary px-2 py-1 text-sm text-secondary-foreground",
