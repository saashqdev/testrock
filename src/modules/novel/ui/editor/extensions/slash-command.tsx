...
const CommandList = ({ items, command, editor, range }: { items: CommandItemProps[]; command: any; editor: any; range: any }) => {
  ...
  return items.length > 0 ? (
    <div
      ...
      className="z-50 h-auto max-h-[330px] w-72 overflow-y-auto scroll-smooth rounded-md border border-stone-200 bg-background px-1 py-2 shadow-md transition-all"
    >
