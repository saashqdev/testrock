...
function type({ code, imports, property }: { code: string[]; imports: string[]; property: PropertyWithDetailsDto }) {
  let type = "";
  if (property.type === PropertyType.TEXT) {
    ...
    imports.push(`import { MediaDto } from "@/lib/dtos/entities/MediaDto";`);
    ...
    imports.push(`import { RowValueMultipleDto } from "@/lib/dtos/entities/RowValueMultipleDto";`);
    type = "RowValueMultipleDto[]";
  } else if (property.type === PropertyType.RANGE_NUMBER) {
    imports.push(`import { RowValueRangeDto } from "@/lib/dtos/entities/RowValueRangeDto";`);
...
function rowToDto({ code, property }: { code: string[]; property: PropertyWithDetailsDto }) {
  let propertyCode = "";
  let comments: string[] = [];
  comments.push(property.isRequired ? "required" : "optional");
  if (property.type === PropertyType.TEXT) {
...
function formToDto({ code, property }: { code: string[]; property: PropertyWithDetailsDto }) {
  let propertyCode = "";
  let comments: string[] = [];
  comments.push(property.isRequired ? "required" : "optional");
  if (property.type === PropertyType.TEXT) {
...
function createDtoToRow({ code, property }: { code: string[]; property: PropertyWithDetailsDto }) {
...
function updateDtoToRow({ code, property }: { code: string[]; property: PropertyWithDetailsDto }) {
...
function uiForm({ code, imports, property, index }: { code: string[]; imports: string[]; property: PropertyWithDetailsDto; index: number }) {
  ...
  if (property.type === PropertyType.TEXT) {
    ...
    imports.push(`import { Colors } from "@/lib/enums/shared/Colors";`);
    props.push(
...
function uiCell({ code, imports, property }: { code: string[]; imports: string[]; property: PropertyWithDetailsDto }) {
  const props: string[] = [];
  if (property.type === PropertyType.TEXT) {
    code.push(`{
            name: "${property.name}",
...
function schema({ code, property }: { code: string[]; property: PropertyWithDetailsDto }) {
