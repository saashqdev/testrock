...
import { loader as kbCategoryLoader } from "@/modules/knowledgeBase/routes/api/KbRoutes.Category.Api";
...
export const loader = (props: IServerComponentsProps) => kbCategoryLoader(props, { kbSlug: "docs" });
