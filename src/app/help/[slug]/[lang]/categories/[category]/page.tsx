...
import * as KbRoutesCategoryApi from "@/modules/knowledgeBase/routes/api/KbRoutes.Category.Api";
import KbRoutesCategoryView from "@/modules/knowledgeBase/routes/views/KbRoutes.Category.View";
import { IServerComponentsProps } from "@/lib/dtos/ServerComponentsProps";

export async function generateMetadata(props: IServerComponentsProps): Promise<Metadata> {
  const data = await KbRoutesCategoryApi.loader(props, { kbSlug: "help" });
  return (data?.metatags as Metadata) || {};
}

export const loader = (props: IServerComponentsProps) => KbRoutesCategoryApi.loader(props);
...
export default async function Page(props: IServerComponentsProps) {
  const data = await KbRoutesCategoryApi.loader(props);
