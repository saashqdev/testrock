...
import { importKbsAction } from "../../actions";
...
export default function ImportKnowledgeBase() {
  const [actionData, formAction, isPending] = useActionState<ActionData | null, FormData>(importKbsAction, null);
