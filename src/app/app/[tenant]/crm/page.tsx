  ...
  return (
    <div className="mx-auto mb-12 max-w-5xl space-y-5 px-4 py-4 sm:px-6 lg:px-8 xl:max-w-7xl">
      ...
      <dl className="grid gap-2 sm:grid-cols-3">
        ...
        >
          <dt className="truncate text-xs font-medium uppercase text-muted-foreground">{t("models.company.plural")}</dt>
        ...
        <Link
          ...
          className="shadow-xs overflow-hidden rounded-lg border border-border bg-background px-4 py-3 hover:bg-secondary"
        >
          <dt className="truncate text-xs font-medium uppercase text-muted-foreground">{t("models.contact.plural")}</dt>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between space-x-2">
          <h3 className="text-sm font-medium text-muted-foreground">{t("models.opportunity.plural")}</h3>
          <Link
